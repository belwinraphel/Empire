...
class _MapConfirmPageState extends State<MapConfirmPage> {
  ...
  // Start somewhere reasonable (Mumbai). Replace with your default.
  ...
  void _onCameraMove(CameraPosition p) {
    // Debounce distance calculation for better performance
    _debounceTimer?.cancel();
  ...
  void _onCameraIdle() {
    // Final calculation when camera stops moving
    if (mounted && _myPosition != null) {
      setState(() {
        _distanceKm = _computeDistanceKm(_pin, _myPosition!);
      });
  ...
  Future<void> _getAddressFromCoordinates(LatLng location) async {
    ...
    try {
      ...
      if (placemarks.isNotEmpty && mounted) {
        ...
        // Line 2: Locality, SubAdministrativeArea or AdministrativeArea
      ...
      body: Stack(
        children: [
          ...
          GoogleMap(
            ...
            // Lite mode for better performance on lower-end devices
  ...
  Widget build(BuildContext context) {
    ...
    final warning = distanceKm == null
        ...
        : distanceKm! > 9
            ...
            : 'Pin location is ${distanceKm!.toStringAsFixed(1)}km away from your current location';
